...
export default function Game() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-6 text-gray-300 bg-gray-950">
      <div className="w-full max-w-md">
        {win && (
          <div className="rounded-md border-l-4 border-green-600 bg-green-400 p-2 mt-4">
            <div className="flex items-center justify-center space-x-4">
              <p className="font-medium text-green-600">HURRAY!! You have won the game</p>
            </div>
          </div>
        )}
        <h1 className="text-3xl text-pink-400 font-bold text-center">PuzzleQuest</h1>
        <h3 className="text-xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 via-sky-200 to-blue-500">
          15 Puzzle Game
        </h3>
        <div className="flex flex-col sm:flex-row justify-between items-center gap-2 px-2 sm:px-6 mt-4">
          <p>Moves: {moves}</p>
        ...
        <div className="px-6 mt-4">
          <button
            onClick={newGame}
            className="text-black font-bold block bg-gray-900 px-4 py-2 rounded w-full text-sm sm:text-base bg-gradient-to-r from-pink-500 via-sky-500 to-pink-500"
          >
            New Game
          </button>
        </div>
