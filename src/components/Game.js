...
return (
	...
	<div className="mx-auto mt-40">
		{win && (
		<div className="rounded-md border-l-4 border-green-600 bg-green-400 p-2 mt-90">
        ...
        from-indigo-500 from-10% via-sky-200 
        via-40% to-blue-500 to-80%">
		15 Puzzle Game
		</h3>
        ...
        h-full bg-gradient-to-r from-pink-500 
            from-10% via-sky-500 via-30% to-pink-500 to-90%"
		>
			New Game
		</button>
		</div>
